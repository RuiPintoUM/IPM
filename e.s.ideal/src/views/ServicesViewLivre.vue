<template>
  ...
  <div class="container-1">
    ...
    <div class="dropdown">
      <button class="dropbtn" @click="toggleDropdown">{{ showDropdown ? 'Fechar' : 'Livre' }}</button>
      <div class="dropdown-content" v-show="showDropdown">
        <a @click="filterServices('Agendado')" href="/servicosatribuidos/agendados">Agendado</a>
      </div>
    </div>
    <div class="container">
  ...
  methods: {
    getServices() {
      fetch('http://localhost:3000/services')
        ...
        .then(data => {
          const filteredServices = data.filter(service => service.agendamento === 'filaDeEspera');
